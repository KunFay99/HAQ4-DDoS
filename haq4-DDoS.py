...
def print_status():
    ...
    sys.stdout.flush()
    print (f"\033[33m=⟩ \033[96mHAQ4-DDoS \033[93mFLOODING HTTP \033[94m" +str(ip)+ "\033[0m")
    sys.stdout.flush()
    print (f"\033[95m=⟩⟩ \033[92mHAQ4-DDoS \033[97mFLOODING HTTP \033[92m" +str(ip)+ "\033[0m")
