...
\033[33mTO THE STABILIZATION OF THE MARTYRS             
...
def print_status():
    ...
    sys.stdout.flush()
    print (f"\033[95m══>> \033[92m[N\033[33mA\033[32mI] \033[32mREQUEST_NUM \033[92m" +str(ip)+ "\033[0m")
    sys.stdout.write(f"\r[💥] \033[95m{time.ctime().split( )[3]}\033[94m [{str(thread_num)}] ")
    sys.stdout.flush()
    print (f"\033[37m══>> \033[33m[H\033[37mA\033[33mI] \033[36mREQUEST_NUM \033[35m" +str(ip)+ "\033[0m")
